export const DETAILS = {
  ...
  profile_links: {
    email: {
      link: "vaidhyanathan.sm@gmail.com",
    ...
    linkedin: {
      link: "https://www.linkedin.com/in/vaidhyanathansm/",
      image : "assets/images/linkedin.svg"
    },
    medium: {
      link: "https://vaidhyanathansm.medium.com/",
      image : "assets/images/medium.svg"
    },
    hackerrank: {
      link : "https://www.hackerrank.com/vaidhyanathan_sm?hr_r=1",
      image : "assets/images/hackerrank.svg"
    },
    geeksforgeeks:
      {
        link : "https://auth.geeksforgeeks.org/user/vaidhyanathansm/profile",
        image : "assets/images/geeksforgeeks.svg"
      },
  },
  ...
  projects:[
    {
      ...
      image: "https://play-lh.googleusercontent.com/YW4d2Z8jZhNE4C6gNFR5kFeV3h8brRp9QAfqgsrxF00TdELiwxRWmyrdEkE7fKhur58=s180-rw",
      description: {
        para1: "The application provides exercises, food and fitness tips for maintaining the health properly.",
        para2: "The application is made completely user-friendly and has an amazing user-experience and has a dark mode in its very first version itself!"
      }
    },
    {
      id: 2,
      ...
      image: "https://play-lh.googleusercontent.com/arjwweu2ecu2V3OWozZUYYm67xWir-8njlyBtmayu33nhmZTFuBZ_E5ZkJe2-loNhg=s180-rw",
      description: {
        para1: "Kick off the artist in you and get your hands to work on something cool. Play with the tools in the art gallery and enjoy drawing. It is completely offline.",
        para2: "The app is completely user-friendly and has a good user interface."
      }
    },
    {
      id: 3,
    ...
    },
    {
      ...
      image: "https://play-lh.googleusercontent.com/J0ReGAfHAH3bm3hVJz5VH1N2aAbv-1AFv-JpbFlwRi_KhelJvTYI575uMtv74hGODA=s180-rw",
      description: {
        para1: "Climate change is sometimes misunderstood as being about changes in the weather. In reality, it is about changes in our very way of life.",
        para2: "Get the weather updates according to your current location.Also, get weather updates of major cities of the world."
      }
    },
    {
      id: 5,
      ...
      image: "https://play-lh.googleusercontent.com/4D3fo8kk8XYPV2kcVZKZdeL07hTxAFFuRKkAWRm7FLOT6TtNrCINKGB5uS7t_whbalZK=s180-rw",
      description: {
        para1: "Dev Portal is a Community Portal for Developers.",
        para2: "It is an initiative to bring the developers across the world to connect with each other and it creates an environment for learning and growing together."
      }
    },
    {
      id: 6,
      ...
      image: "https://play-lh.googleusercontent.com/8pHsVCV8O9fOKFSGAsp5vKY5GFBTJNKPx5k_NyyVhAmITaClfnkN2VpHIH1HGIW5OA=s180-rw",
      description: {
        para1: "There are extraordinary features such as Advanced and Basic Calculators and Math puzzles and Games that will make children to love Mathematics.",
    ...
    },
    {
      ...
      description: {
        para1: "Custom Utility Header Files are created from scratch in C++ for performing various operations on Data Structures.",
        para2: "Additional functionalities are added for performing various operations on Arrays, Linked Lists and Trees."
      }
    }
  ],
  experiences:[
    {
      ...
      description: "Worked on an Internal Project",
    ...
    },
    {
      ...
      description: "Part Time - Worked in the field of Web Development and maintenance of the website",
    ...
    },
    {
      ...
      type: "Internship",
      company: "SocialFriend Stressfree LLP",
      description: "Worked with Flask framework for creating their Web Platform. Built a robust Android App for creating their Mobile Platform. The application both in Mobile and Web version is a platform developed for school students which connects them with mentors and teachers",
    ...
    },
    {
      ...
      type: "Internship",
      company: "Toshiba Machine (Chennai) Pvt Ltd",
      description: "Worked with Qt (C++) framework for creation of HMI for their manufacturing sector to monitor the working of their machines.",
      timeline: "Jun 2020 - Jul 2019"
    },
